  ...
  return (
    <div className='footerDiv'>
      <div className='footerLinks'>
        <h1 className='link hidden md:inline-flex'>How it was made</h1>
        <DesktopComputerIcon className='footerIcons' />
        <h1 className='link hidden md:inline-flex'>8luM3CT0</h1>
        <UserIcon className='footerIcons rounded-full border border-gray-50' />
      </div>
      <div className='footerLinks'>
        <h1 className='link hidden md:inline-flex'>Contact</h1>
        <InboxIcon className='footerIcons' />
        <h1 className='link hidden md:inline-flex'>Github</h1>
        <img
        ...
        />
        <h1 className='link hidden md:inline-flex'>LinkedIn</h1>
